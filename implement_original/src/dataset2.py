...
class ThreeLabelDataset(Dataset):
    def __init__(self, pos_seq_ids, neg_seq_ids, neutral_seq_ids, vocab, max_seq_length):
        self.seq_label_pairs = [(ids, 0) for ids in pos_seq_ids] + [(ids, 1) for ids in neg_seq_ids] + [(ids, 0.5) for ids in neutral_seq_ids]
