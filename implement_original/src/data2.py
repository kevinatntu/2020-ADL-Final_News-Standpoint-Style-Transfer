...
def preprocess_3label(data_dir='./data/task3/', task='task3', lang='zh'):
    ...
    # read data
    filename_list = [
        'train.0', 'train.1', 'train.05', 
        'dev.0', 'dev.1', 'dev.05', 
        'test.0', 'test.1', 'test.05'
        ]

    # build word pool
    print('collecting words...')
    for i in range(3):
        with open(data_dir + filename_list[i*3], 'r', encoding='utf-8') as f:
            for line in f:
        ...
        with open(data_dir + filename_list[i*3+1], 'r', encoding='utf-8') as f:
            for line in f:
                line = line.strip().lower()
                if line == '':
                    continue
        ...
        with open(data_dir + filename_list[i*3+2], 'r', encoding='utf-8') as f:
            for line in f:
                line = line.strip().lower()
                if line == '':
                    continue
