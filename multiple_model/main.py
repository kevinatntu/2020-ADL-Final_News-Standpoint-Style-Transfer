...
parser.add_argument('--transformer_model_size', type=int, default=312) # To match BERT
parser.add_argument('--transformer_ff_size', type=int, default=1024)
parser.add_argument('--latent_size', type=int, default=312) # To match BERT
...
parser.add_argument('--PRETRAINED_MODEL_NAME', type=str, default="clue/albert_chinese_tiny",
    help='you can choose [clue/albert_chinese_tiny, google/bert_uncased_L-2_H-256_A-4]')
...
parser.add_argument('--use_albert', action="store_true", default=False)
parser.add_argument('--use_tiny_bert', action="store_true", default=False)
parser.add_argument('--use_distil_bert', action="store_true", default=False)
...
def train_iters(ae_model, dis_model):
    if args.use_albert:
        tokenizer = BertTokenizer.from_pretrained("clue/albert_chinese_tiny", do_lower_case=True)
    elif args.use_tiny_bert:
        tokenizer = AutoTokenizer.from_pretrained("google/bert_uncased_L-2_H-256_A-4", do_lower_case=True)
